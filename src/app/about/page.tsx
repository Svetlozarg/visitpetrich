        ...
        >
          ...
          <Stack width="100%" maxWidth={{ md: "600px" }} gap={2}>
            ...
            <Typography component="p" variant="body1" textAlign="justify">
              Градът е наследник на античния град Хераклея Синтика, който
              възниква през V - IV век пр. Хр. в подножието на планината Кожух,
              местност Рупите. През 168 година пр. Хр. Хераклея Синтика е
